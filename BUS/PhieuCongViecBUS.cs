...
namespace BaiMoiiii.BUS
{
    public class PhieuCongViecBUS
    {
        ...
        // 🎯 BUS nhận DAL qua DI
        public PhieuCongViecBUS(PhieuCongViecDAL dal)
        {
            _dal = dal;
        }
        ...
        {
            if (id <= 0) throw new ArgumentException("Mã phiếu không hợp lệ!");
        ...
        {
            if (p.MaPhieuCV <= 0)
                throw new ArgumentException("Mã phiếu không hợp lệ!");
